...
int main(int argc, char * argv[]) {
    ...
    if (argc == 6)
        lr = (float) atof(argv[1]), eps = atoi(argv[2]), main_script = argv[3],weight_file=argv[4], debug = atoi(argv[5]);
    py_init();
    if (python_user_script(main_script)!=0) $
